...
export default () => {
	...
	const defaultData = [
		...
		// 	spellsList: [
		// 		// types: class, background, feat, item, race
		// 		{ ...spells.find(spell => spell.index === "druidcraft"), isPrepared: true, isTypeClass: true, },
		// 		{ ...spells.find(spell => spell.index === "animal-friendship"), isPrepared: true, isTypeClass: true, },
		// 		{ ...spells.find(spell => spell.index === "chill-touch"), isPrepared: true, isTypeClass: true, },
		// 		{ ...spells.find(spell => spell.index === "thunderwave"), isPrepared: true, isTypeClass: true, },
		// 		{ ...spells.find(spell => spell.index === "aid"), isPrepared: true, isTypeClass: true, },
		// 		{ ...spells.find(spell => spell.index === "guidance"), isPrepared: false, isTypeClass: true, },
		// 		{ ...spells.find(spell => spell.index === "purify-food-and-drink"), isPrepared: true, isTypeClass: true, },
		// 	].map(formatSpell),
